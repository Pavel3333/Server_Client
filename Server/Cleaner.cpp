...
void Cleaner::printCommandsListImpl()
{
...
void Cleaner::cleanInactiveClientsImpl(bool ext)
{
    size_t cleaned = 0;
...
void Cleaner::inactiveClientsCleanerImpl()
{
    // Задать имя потоку
